...
class AccountBalanceOverview extends BaseWidget
{
    ...
    protected function getStats(): array
    {
        ...
        $assets = $accountService->getCategoryTotal(AccountCategory::Asset, $startDate, $endDate);
        $liabilities = $accountService->getCategoryTotal(AccountCategory::Liability, $startDate, $endDate);
        $equity = $accountService->getCategoryTotal(AccountCategory::Equity, $startDate, $endDate);
